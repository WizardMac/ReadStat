...
#line 109 "src/spss/readstat_sav_parse_mr_name.rl"
...
#line 88 "src/spss/readstat_sav_parse_mr_name.c"
	{
...
#line 176 "src/spss/readstat_sav_parse_mr_name.c"
...
#line 187 "src/spss/readstat_sav_parse_mr_name.c"
...
#line 222 "src/spss/readstat_sav_parse_mr_name.c"
...
#line 249 "src/spss/readstat_sav_parse_mr_name.c"
...
#line 277 "src/spss/readstat_sav_parse_mr_name.c"
...
#line 130 "src/spss/readstat_sav_parse_mr_name.rl"

	
	// Check if FSM finished successfully
	if (cs < 
#line 297 "src/spss/readstat_sav_parse_mr_name.c"
9
#line 133 "src/spss/readstat_sav_parse_mr_name.rl"
 || p != pe) {
...
#line 336 "src/spss/readstat_sav_parse_mr_name.c"
...
#line 204 "src/spss/readstat_sav_parse_mr_name.rl"
...
#line 391 "src/spss/readstat_sav_parse_mr_name.c"
	{
		int _klen;
		unsigned int _trans = 0;
		const char * _keys;
		...
		if ( _mr_parser_cond_actions[_trans] != 0 ) {
			...
			while ( _nacts > 0 ) {
				switch ( (*( _acts)) )
				{
					case 0:  {
							{
#line 174 "src/spss/readstat_sav_parse_mr_name.rl"
...
#line 488 "src/spss/readstat_sav_parse_mr_name.c"
...
4
#line 218 "src/spss/readstat_sav_parse_mr_name.rl"
 || p != pe) {
		retval = READSTAT_ERROR_BAD_MR_STRING;
		goto cleanup;
	}
