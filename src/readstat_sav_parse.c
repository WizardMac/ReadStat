...
cs = 0;
	goto _out;
tr0:
#line 131 "src/readstat_sav_parse.rl"
	{ key_offset = 0; }
#line 131 "src/readstat_sav_parse.rl"
	{ temp_key[key_offset++] = (*p); }
	goto st2;
st2:
	if ( ++p == pe )
		goto _test_eof2;
case 2:
#line 1648 "src/readstat_sav_parse.c"
	switch( (*p) ) {
		case 46u: goto tr2;
		case 61u: goto tr3;
		case 95u: goto tr2;
...
st3:
	if ( ++p == pe )
		goto _test_eof3;
case 3:
#line 1674 "src/readstat_sav_parse.c"
	switch( (*p) ) {
		case 46u: goto tr4;
		case 61u: goto tr3;
		case 95u: goto tr4;
...
st4:
	if ( ++p == pe )
		goto _test_eof4;
case 4:
#line 1700 "src/readstat_sav_parse.c"
	switch( (*p) ) {
		case 46u: goto tr5;
		case 61u: goto tr3;
		case 95u: goto tr5;
...
st5:
	if ( ++p == pe )
		goto _test_eof5;
case 5:
#line 1726 "src/readstat_sav_parse.c"
	switch( (*p) ) {
		case 46u: goto tr6;
		case 61u: goto tr3;
		case 95u: goto tr6;
...
st6:
	if ( ++p == pe )
		goto _test_eof6;
case 6:
#line 1752 "src/readstat_sav_parse.c"
	switch( (*p) ) {
		case 46u: goto tr7;
		case 61u: goto tr3;
		case 95u: goto tr7;
...
st7:
	if ( ++p == pe )
		goto _test_eof7;
case 7:
#line 1778 "src/readstat_sav_parse.c"
	switch( (*p) ) {
		case 46u: goto tr8;
		case 61u: goto tr3;
		case 95u: goto tr8;
...
st8:
	if ( ++p == pe )
		goto _test_eof8;
case 8:
#line 1804 "src/readstat_sav_parse.c"
	switch( (*p) ) {
		case 46u: goto tr9;
		case 61u: goto tr3;
		case 95u: goto tr9;
...
st9:
	if ( ++p == pe )
		goto _test_eof9;
case 9:
#line 1830 "src/readstat_sav_parse.c"
	if ( (*p) == 61u )
		goto tr3;
	goto st0;
tr3:
...
st10:
	if ( ++p == pe )
		goto _test_eof10;
case 10:
#line 1842 "src/readstat_sav_parse.c"
	if ( 48u <= (*p) && (*p) <= 57u )
		goto tr10;
	goto st0;
tr10:
...
st11:
	if ( ++p == pe )
		goto _test_eof11;
case 11:
#line 1868 "src/readstat_sav_parse.c"
	if ( (*p) == 0u )
		goto tr11;
	if ( 48u <= (*p) && (*p) <= 57u )
		goto tr12;
...
st12:
	if ( ++p == pe )
		goto _test_eof12;
case 12:
#line 1887 "src/readstat_sav_parse.c"
	switch( (*p) ) {
		case 0u: goto st12;
		case 9u: goto st13;
	}
...
#line 141 "src/readstat_sav_parse.rl"

    
    if (cs < 
#line 1925 "src/readstat_sav_parse.c"
12
#line 143 "src/readstat_sav_parse.rl"
 || p != pe) {
