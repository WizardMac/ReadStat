...
#line 3509 "src/readstat_sav_parse.c"
	{
	cs = sav_very_long_string_parse_start;
	}

#line 3514 "src/readstat_sav_parse.c"
	{
	if ( p == pe )
		goto _test_eof;
	switch ( cs )
...
st2:
	if ( ++p == pe )
		goto _test_eof2;
case 2:
#line 3544 "src/readstat_sav_parse.c"
	switch( (*p) ) {
		case 46u: goto st3;
		case 61u: goto tr6;
		case 95u: goto st3;
...
#line 191 "src/readstat_sav_parse.rl"
	{ str_len = p - str_start; }
#line 174 "src/readstat_sav_parse.rl"
	{
            memcpy(temp_key, str_start, str_len);
            temp_key[str_len] = '\0';
        }
...
st10:
	if ( ++p == pe )
		goto _test_eof10;
case 10:
#line 3750 "src/readstat_sav_parse.c"
	if ( 48u <= (*p) && (*p) <= 57u )
		goto tr34;
	goto st0;
tr34:
#line 193 "src/readstat_sav_parse.rl"
	{ temp_val = 0; }
...
st11:
	if ( ++p == pe )
		goto _test_eof11;
case 11:
#line 3776 "src/readstat_sav_parse.c"
	if ( (*p) == 0u )
		goto tr35;
	if ( 48u <= (*p) && (*p) <= 57u )
		goto tr36;
...
st12:
	if ( ++p == pe )
		goto _test_eof12;
case 12:
#line 3825 "src/readstat_sav_parse.c"
	if ( 128u <= (*p) && (*p) <= 191u )
		goto st2;
	goto st0;
tr3:
...
st13:
	if ( ++p == pe )
		goto _test_eof13;
case 13:
#line 3837 "src/readstat_sav_parse.c"
	if ( 128u <= (*p) && (*p) <= 191u )
		goto st12;
	goto st0;
tr4:
...
st14:
	if ( ++p == pe )
		goto _test_eof14;
case 14:
#line 3849 "src/readstat_sav_parse.c"
	if ( 128u <= (*p) && (*p) <= 191u )
		goto st13;
	goto st0;
st15:
