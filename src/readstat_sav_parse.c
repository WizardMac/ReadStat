...
#line 29 "src/readstat_sav_parse.c"
...
#line 78 "src/readstat_sav_parse.c"
	{
	cs = sav_long_variable_parse_start;
	}

#line 83 "src/readstat_sav_parse.c"
	{
	if ( p == pe )
		goto _test_eof;
	switch ( cs )
...
cs = 0;
	goto _out;
tr0:
#line 94 "src/readstat_sav_parse.rl"
	{ str_start = p; }
	goto st2;
st2:
	if ( ++p == pe )
		goto _test_eof2;
case 2:
#line 113 "src/readstat_sav_parse.c"
	switch( (*p) ) {
		case 46u: goto st3;
		case 61u: goto tr6;
		case 95u: goto st3;
...
#line 94 "src/readstat_sav_parse.rl"
	{ str_len = p - str_start; }
#line 78 "src/readstat_sav_parse.rl"
	{
...
st10:
	if ( ++p == pe )
		goto _test_eof10;
case 10:
#line 319 "src/readstat_sav_parse.c"
	if ( (*p) < 192u ) {
		if ( 32u <= (*p) && (*p) <= 126u )
			goto tr34;
	} else if ( (*p) > 223u ) {
	...
	goto st0;
tr34:
#line 96 "src/readstat_sav_parse.rl"
	{ str_start = p; }
	goto st227;
st227:
	if ( ++p == pe )
		goto _test_eof227;
case 227:
#line 340 "src/readstat_sav_parse.c"
	if ( (*p) == 9u )
		goto tr233;
	if ( (*p) < 192u ) {
		if ( 32u <= (*p) && (*p) <= 126u )
...
#line 96 "src/readstat_sav_parse.rl"
	{ str_len = p - str_start; }
#line 83 "src/readstat_sav_parse.rl"
	{
            memcpy(temp_val, str_start, str_len);
            temp_val[str_len] = '\0';
        }
#line 69 "src/readstat_sav_parse.rl"
	{
...
st228:
	if ( ++p == pe )
		goto _test_eof228;
case 228:
#line 377 "src/readstat_sav_parse.c"
	if ( (*p) < 192u ) {
		if ( 64u <= (*p) && (*p) <= 90u )
			goto tr0;
	} else if ( (*p) > 223u ) {
...
st11:
	if ( ++p == pe )
		goto _test_eof11;
case 11:
#line 398 "src/readstat_sav_parse.c"
	if ( 128u <= (*p) && (*p) <= 191u )
		goto st2;
	goto st0;
tr3:
...
st12:
	if ( ++p == pe )
		goto _test_eof12;
case 12:
#line 410 "src/readstat_sav_parse.c"
	if ( 128u <= (*p) && (*p) <= 191u )
		goto st11;
	goto st0;
tr4:
...
st13:
	if ( ++p == pe )
		goto _test_eof13;
case 13:
#line 422 "src/readstat_sav_parse.c"
	if ( 128u <= (*p) && (*p) <= 191u )
		goto st12;
	goto st0;
st229:
...
st203:
	if ( ++p == pe )
		goto _test_eof203;
case 203:
#line 2880 "src/readstat_sav_parse.c"
	if ( 128u <= (*p) && (*p) <= 191u )
		goto st227;
	goto st0;
tr36:
...
st204:
	if ( ++p == pe )
		goto _test_eof204;
case 204:
#line 2892 "src/readstat_sav_parse.c"
	if ( 128u <= (*p) && (*p) <= 191u )
		goto st203;
	goto st0;
tr37:
...
st205:
	if ( ++p == pe )
		goto _test_eof205;
case 205:
#line 2904 "src/readstat_sav_parse.c"
	if ( 128u <= (*p) && (*p) <= 191u )
		goto st204;
	goto st0;
st206:
...
#line 69 "src/readstat_sav_parse.rl"
	...
	break;
#line 3432 "src/readstat_sav_parse.c"
	}
	}
