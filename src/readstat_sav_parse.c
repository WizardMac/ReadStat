...
#line 77 "src/readstat_sav_parse.c"
	{
	cs = sav_long_variable_parse_start;
	}

#line 82 "src/readstat_sav_parse.c"
	{
	if ( p == pe )
		goto _test_eof;
	switch ( cs )
...
st2:
	if ( ++p == pe )
		goto _test_eof2;
case 2:
#line 112 "src/readstat_sav_parse.c"
	switch( (*p) ) {
		case 46u: goto st3;
		case 61u: goto tr6;
		case 95u: goto st3;
...
st10:
	if ( ++p == pe )
		goto _test_eof10;
case 10:
#line 318 "src/readstat_sav_parse.c"
	if ( (*p) < 192u ) {
		if ( 32u <= (*p) && (*p) <= 126u )
			goto tr34;
	} else if ( (*p) > 223u ) {
...
st227:
	if ( ++p == pe )
		goto _test_eof227;
case 227:
#line 339 "src/readstat_sav_parse.c"
	if ( (*p) == 9u )
		goto tr233;
	if ( (*p) < 192u ) {
		if ( 32u <= (*p) && (*p) <= 126u )
...
#line 70 "src/readstat_sav_parse.rl"
	...
	break;
#line 3435 "src/readstat_sav_parse.c"
	}
	}
...
#line 3519 "src/readstat_sav_parse.c"
	{
...
cs = 0;
	goto _out;
tr0:
#line 203 "src/readstat_sav_parse.rl"
	{ str_start = p; }
	goto st2;
st2:
	if ( ++p == pe )
		goto _test_eof2;
case 2:
#line 3554 "src/readstat_sav_parse.c"
	switch( (*p) ) {
		case 46u: goto st3;
		case 61u: goto tr6;
		case 95u: goto st3;
...
st10:
	if ( ++p == pe )
		goto _test_eof10;
case 10:
#line 3760 "src/readstat_sav_parse.c"
	if ( 48u <= (*p) && (*p) <= 57u )
		goto tr34;
	goto st0;
tr34:
#line 205 "src/readstat_sav_parse.rl"
	{ temp_val = 0; }
...
st11:
	if ( ++p == pe )
		goto _test_eof11;
case 11:
#line 3786 "src/readstat_sav_parse.c"
	if ( (*p) == 0u )
		goto tr35;
	if ( 48u <= (*p) && (*p) <= 57u )
		goto tr36;
	goto st0;
tr35:
#line 179 "src/readstat_sav_parse.rl"
	{
            varlookup_t *found = bsearch(temp_key, table, var_count, sizeof(varlookup_t), &compare_key_varlookup);
            if (found) {
...
st36:
	if ( ++p == pe )
		goto _test_eof36;
case 36:
#line 3805 "src/readstat_sav_parse.c"
	switch( (*p) ) {
		case 0u: goto st36;
		case 9u: goto st37;
	}
...
st14:
	if ( ++p == pe )
		goto _test_eof14;
case 14:
#line 3859 "src/readstat_sav_parse.c"
	if ( 128u <= (*p) && (*p) <= 191u )
		goto st13;
	goto st0;
st15:
...
#line 213 "src/readstat_sav_parse.rl"
